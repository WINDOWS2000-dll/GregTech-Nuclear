...
public interface IModule {
     ...
     * <p>
     * e.g. {@code new ResourceLocation("gtnuclear", "foo_module")} represents a dependency on the module
     * "foo_module" in the container "gtnuclear"
     */
    @NotNull
    ...
    /**
     * Register packets using your mod's packet handling of choice here.
     */
